                  ...
                  <div class="header-info-left d-flex align-items-center">
                    <div class="logo">
                      <a href="index.php">
                        ...
                        <img style="width:300px;" src="./assets/img/logo4_dhhanu.png" alt="" data-pagespeed-url-hash="3800066785" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
                      </a>
                    </div>
        ...
        <div class="header-bottom header-sticky">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-xl-12">
                <div class="logo2">
                  <a href="index.php"><img width="200px" src="./assets/img/logo4_dhhanu.png" alt="" data-pagespeed-url-hash="3800066785" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" /></a>
                </div>
