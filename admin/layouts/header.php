...
<head>
    ...
    <link rel="icon" type="image/png" sizes="46x35" href="<?=$baseUrl?>../assets/plugins/images/logo-text_.png">
                ...
                <div class="navbar-header" data-logobg="skin6" style="background: #fef4f4;">
                    <a class="navbar-brand" href="<?=$baseUrl?>../">
                        <span class="logo-text">
                            ...
                            <!-- <img width="100px" height="50px" style="position:relative;left:10px;" width="40px" src="<?=$baseUrl?>../assets/plugins/images/logo-text_8.png"/> -->
                        </span>
                    </a>
